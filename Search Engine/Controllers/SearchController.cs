...
namespace Search_Engine.Controllers
{
    public class SearchController : Controller
    {
        ...
        //return the nearst words to the miss spelled word entered by the user
        public List<string> spellchecker_words(String misspelled)
        {
            ...
            //calculate jaccard coffienet and take that higher than 0.45 and store it in nearwords_coffs to apply edit distance on them
            ...
            //return words with the minimum edit distance 
        ...
        //return list of words with the same phonetic hash to the word enterd by the user
        public List<String> Soundex_words(String misspelled)
        {
            ...
            // to retrieve all words with same phonetic hash
            List<string> Same_Soundex_Hash = new List<string>();
            SqlConnection connection = new SqlConnection(@"Data Source=DESKTOP-KMG2RBB\SQLEXPRESS;Initial Catalog=web_crawler;Integrated Security=True");
            connection.Open();
        ...
        // function to check if doc is contain ALL query words in the same order submitted by the user , if yes calculate cumulative frequency for each document for ranking
        ...
        //calc the minimum distance betwen the words in each doc 
        public List<Tuple<int, float, List<Tuple<String, int, List<int>>>>> calculate_distance(List<Tuple<int, List<Tuple<String, int, List<int>>>>> docs, int count)
        {
            ...
            for (int doc = 0; doc < docs.Count; doc++)
            {
                ...
                for (int word = 0; word < count; word++)
                {
                    ...
                    // if the document contain 1 word
                    if (count == 1)
                    {
                        //min_sum = retrieve the minimum position of this word in this document 
                        min_sum = docs.ElementAt(doc).Item2.ElementAt(word).Item3.ElementAt(0); // store the minimum position
                        break;
                    }

                    //otherwise we retrieve the minimum sum (distance) between the words in each document
        ...
        //apply the kgram algorithm by taking the word and value of k (num of grams) and return list of grams to apply edit distance on it
        ...
        //apply soundex algorithm and return phonetic hash 
        /*1.Retain the first letter of the word.
          2.Change all occurrences of the following letters to  corresponing numbers
          3.Remove all pairs of consecutive digits.
          4.Remove all zeros from the resulting string.
          5.Pad the resulting string with trailing zeros and return the first four positions*/
